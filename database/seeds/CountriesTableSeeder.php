...
class CountriesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $values = [
			...
			['country_code' => 'CD', 'country_name' => 'Democratic Republic of Congo'],
			...
			['country_code' => 'EC', 'country_name' => 'Ecudaor'],
			...
			['country_code' => 'SS', 'country_name' => 'Republic of South Sudan'],
			...
			['country_code' => 'SR', 'country_name' => 'Suricountry_name'],
