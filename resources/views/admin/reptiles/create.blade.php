...
@section('title', 'Add Reptile or Amphibian')
@section('page-title', 'Add New Reptile or Amphibian')

@section('content')
    <!--Permission Create Box Starts Here-->
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Add Reptile and Amphibian</h3>
        </div>
        <div class="box-body">
            <!--Form Start-->
            <form action="{{route('reptileAmphibian.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    <label for="wingspan">Reproduction Type</label>
                    <select class="form-control" name="reproduction_type">
                        <option value="Lay Eggs">Lay Eggs</option>
                        <option value="Livebearer">Livebearer</option>
                    </select>
                </div>

                <div class="form-group">
                    <label for="wingspan">Average Offspering</label>
                    <input type="number" id="offspring" name="offspring" class="form-control">
                </div>
